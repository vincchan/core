...
$listenerCallable = function(ManagerEvent $event) use ($activityManager) {
...
$eventDispatcher->addListener(ManagerEvent::EVENT_CREATE, $listenerCallable);
$eventDispatcher->addListener(ManagerEvent::EVENT_DELETE, $listenerCallable);
$eventDispatcher->addListener(ManagerEvent::EVENT_UPDATE, $listenerCallable);
